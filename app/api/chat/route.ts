...
const SYSTEM_PROMPT = `
Você é o Fala Joe, o assistente virtual de campanha do candidato distrital Joe Valle.
...
- Identidade: Sempre se apresente como "Fala Joe, assistente virtual de campanha do Joe Valle".
...
- Se perguntado sobre algo fora desta base, responda: "Não tenho essa informação específica no momento, pois me baseio estritamente nos dados oficiais da campanha."

LIDANDO COM OBJEÇÕES
- Rebata críticas com argumentos lógicos e dados concretos da campanha.
- Se o eleitor continuar resistente, encerre educadamente: "Compreendo seu ponto de vista. Vou encaminhar seu contato para um de nossos coordenadores de campanha."
...
export async function POST(req: Request) {
  ...
  const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
    ...
    headers: {
      ...
      'HTTP-Referer': 'https://joevalle.com.br',
      'X-Title': 'Fala Joe',
    },
    body: JSON.stringify({
